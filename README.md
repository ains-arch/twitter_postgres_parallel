...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/ains-arch/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/ains-arch/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/ains-arch/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/ains-arch/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/ains-arch/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/ains-arch/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |  2m0.104s                 |  1:08.33                  | 
| `pg_normalized_batch`  |  1m53.252s                |  0:14.04                  | 
| `pg_denormalized`      |  0m17.854s                |  0:04.40                  | 
